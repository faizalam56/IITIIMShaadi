 ...
 *
 */
 final class EventListener implements YouTubePlayer.PlaybackEventListener {
 ...
 final class StateChangeListener implements YouTubePlayer.PlayerStateChangeListener {
