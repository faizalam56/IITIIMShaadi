...
public class SearchResultDetailFragment extends Fragment implements View.OnClickListener{
    ...
    private void prepareListData() {
        ...
        listDataHeader.add("Acquiantances");
        ...
        familyDetails.add("Father Occupation");
        familyDetails.add("Mother's Name");
        familyDetails.add("Mother's Occupation");
        familyDetails.add("Details On Sister");
        familyDetails.add("Details On Brother");
    ...
    private void prepareListDataPartner() {
        ...
        // Adding child data
        List<String> basicsLifestyle = new ArrayList<String>();
        basicsLifestyle.add("Min Age");
        basicsLifestyle.add("Max Age");
